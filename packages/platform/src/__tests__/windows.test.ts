/**
 * Windows platform adapter unit tests
 */
...
describe('WindowsAdapter', () => {
  ...
  describe('getSystemInfo', () => {
    it('should return system information', () => {
      ...
      expect(info).toHaveProperty('platform', 'win32');
  ...
  describe('blockShortcuts', () => {
    it('should store blocked shortcuts', () => {
      adapter.blockShortcuts({
        blocked: ['Alt+F4', 'Ctrl+Alt+Delete'],
        allowDevTools: true,
      });
  ...
  describe('kioskMode', () => {
    ...
    it('should unblock shortcuts when disabling kiosk mode', async () => {
      adapter.blockShortcuts({ blocked: ['Alt+F4'] });
      await adapter.enableKioskMode();
      await adapter.disableKioskMode();
  ...
  describe('getAppDataPath', () => {
    it('should return a path ending with kiosk-shell', () => {
